...
Each concept resides in its own package and supplies a `Main.java`, so it can be run directly from IntelliJ IDEA. [solid/solid.md](src/main/java/com/ronak/javarealworld/solid/solid.md) and [designpatterns/designpatterns.md](src/main/java/com/ronak/javarealworld/designpatterns/designpatterns.md) document their examples' business problem, design, important classes, run target, and takeaways.
